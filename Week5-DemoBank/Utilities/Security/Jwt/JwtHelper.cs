...
using Week5_DemoBank_Business.Utilities.Security.Encyption;
using Microsoft.IdentityModel.Tokens;
using System;
using Week5_DemoBank_Entities.Concrete;
using System.Collections.Generic;
using System.IdentityModel.Tokens.Jwt;
using Week5_DemoBank_Business.Extensions;
...
namespace Week5_DemoBank_Business.Utilities.Security.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        private IEnumerable<Claim> SetClaims(User user, List<OperationClaim> operationClaims)
        {
            ...
            claims.AddBankAccountName(user.BankAccountName);//!Müşteri numarası yerine kullanılacak
